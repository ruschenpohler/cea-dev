...
| Intervention | Effect (SD) | Cost/ben. (USD) | Duration (yrs) |
|---|---|---|---|
...
| Rank | Intervention | Effect (SD) | Cost (USD) | Effectiveness (SD/USD) | Cost per 0.1 SD (USD) |
|---|---|---|---|---|---|
...
| Rank | Intervention | Unadjusted CE* (USD) | Time-adj. CE* (USD) | Rank shift |
|---|---|---|---|---|
